...
import { Box, Button, Card, Code, Container, Dialog, Flex, Grid, Heading, Popover, ScrollArea, Separator, Strong, Text, TextField } from "@radix-ui/themes";
          ...
          {video ? (
            <Flex width="100%" height="100%" px="16px" pt="16px" gap="2">
              <Flex width="100%" direction="column">
                ...
                {/* transcript */}
                <ScrollArea style={{height: `calc(100vh - 16px - ${VIDEO_OPTIONS.height}px)`}} size="2" type="always">
                  <Box height="4px" />
                  <Flex direction="column" gap="2" mr="4">
                    {video.transcript_parsed.map(t => <Box key={t.id}>
                      {/* {t.range + '\n' + t.text} */}
              ...
              <ScrollArea style={{height: `calc(100vh - 16px)`}} size="2" type="always">
                <Flex direction="column" gap="2" mr="4">
                  <Heading className="text-center">{`${video.total_segments} segments`}</Heading>
                  {video.segments.map((s, i) => <Card key={i} onClick={() => {
                    ...
                    <Flex align="center" gap="2">
                      ...
                      <Text className="flex-grow">{s.title}</Text>
